"""Canonical session_state keys for LifeBudget Micro."""
...
FLOW_KEYS = [CURRENT_STEP, USER_INTENT, STEP2_OPEN, GOAL_MODE, GOAL_SELECTED, POSITION_CONFIRMED, CONFIRMED_SNAPSHOT, PLAN_READY, PLAN_GENERATED, SHOW_PLAN_B, PLANNING_SNAPSHOT, DOWNSTREAM_INPUTS_DIRTY]

STEP1_WIDGET_KEYS = [
    STEP1_INCOME_AMOUNT, STEP1_INCOME_PERIOD, STEP1_ESTIMATED_GROSS_INCOME, STEP1_ESTIMATED_GROSS_PERIOD,
    STEP1_ESTIMATED_TAX_RATE, STEP1_FIXED_AMOUNT, STEP1_FIXED_PERIOD, STEP1_VARIABLE_AMOUNT,
    STEP1_VARIABLE_PERIOD, STEP1_DISCRETIONARY_AMOUNT, STEP1_DISCRETIONARY_PERIOD, STEP1_TARGET_WEEKLY_SAVINGS,
    STEP1_FIXED_BREAKDOWN_DF, STEP1_VAR_UTILITIES_AMOUNT, STEP1_VAR_UTILITIES_PERIOD, STEP1_VAR_GROCERIES_AMOUNT,
    STEP1_VAR_GROCERIES_PERIOD, STEP1_VAR_HOUSEHOLD_AMOUNT, STEP1_VAR_HOUSEHOLD_PERIOD, STEP1_VAR_COMMUTE_DAYS,
    STEP1_VAR_COMMUTE_COST, STEP1_VAR_SEASON,
]
STEP1_PRIVATE_KEYS = [STEP1_PENDING_WIDGET_PATCH, STEP1_PENDING_SUCCESS_MESSAGE, STEP1_PLANNING_SNAPSHOT_PREVIEW]
STEP1_KEYS = STEP1_WIDGET_KEYS + STEP1_PRIVATE_KEYS

STEP1_DERIVED_KEYS = [INCOME_W, FIXED_TOTAL_W, DISCRETIONARY_W, WEEKLY_MARGIN, FIXED_W, VAR_W, DISC_W, FIXED_ITEMS_ROWS_WEEKLY, VARIABLE_ITEMS_ROWS_WEEKLY, VARIABLE_TOP_DRIVER, VARIABLE_PARTS, MONTHLY_INCOME_DERIVED, ESSENTIAL_SPENDING_MONTHLY_DERIVED, DISCRETIONARY_SPENDING_MONTHLY_DERIVED, WEEKLY_SAVINGS_DERIVED]

STEP2_WIDGET_KEYS = [
    STEP2_PLANNING_HORIZON_WEEKS, STEP2_UNCERTAINTY_PRESET, STEP2_RANDOM_RUN_NONCE, STEP2_ENABLE_ONE_OFF_EVENTS,
    STEP2_ONE_OFF_EVENTS_DF, STEP2_BUFFER_GOAL_AMOUNT_INPUT, STEP2_BUFFER_GOAL_WEEKS_INPUT, STEP2_BUFFER_GOAL_PRIORITY_INPUT,
]
STEP2_PRIVATE_KEYS = [STEP2_SELECTED_PRESET, STEP2_TARGET_INITIALIZED, STEP2_TARGET_USER_TOUCHED_INTERNAL, STEP2_BASELINE_WEEKLY_SEEDED, STEP2_SUGGESTION_FEEDBACK]
STEP2_KEYS = STEP2_WIDGET_KEYS + STEP2_PRIVATE_KEYS

BASELINE_KEYS = [BASELINE_DF, BASELINE_READY, BASELINE_SIGNATURE, PLAN_A_DF, PLAN_B_DF, TARGET_A_WEEKLY, TARGET_A_WEEKLY_USER_TOUCHED, TARGET_B_WEEKLY]
PROJECTION_KEYS = [PROJECTION_OPEN, INVESTMENT_PROJECTION_RESULT, INVESTMENT_PROJECTION_SIGNATURE, INVESTMENT_PROJECTION_COMPARE_ENABLED, INVESTMENT_PROJECTION_COMPARE_HORIZONS, INVESTMENT_PROJECTION_COMPARE_RESULTS, INVESTMENT_PROJECTION_COMPARE_SIGNATURE]
